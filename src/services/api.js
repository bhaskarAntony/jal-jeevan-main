...
const API_BASE_URL = 'https://jal-jeevan-sctd.onrender.com/api'
...
export const gpAdminAPI = {
  ...
  getBillByHouse: (id) => api.get(`/gp-admin/houses/${id}`),
  updateBill: (id) => api.get(`/gp-admin/bills/${id}`),
  deleteBill: (id) => api.get(`/gp-admin/bills/${id}`),
